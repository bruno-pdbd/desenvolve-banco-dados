...
CREATE TABLE `aluno_disciplina` (
  `id_a` int NOT NULL,
  `id_d` int NOT NULL,
  PRIMARY KEY (`id_a`,`id_d`),
  KEY `id_d` (`id_d`),
  CONSTRAINT `aluno_disciplina_ibfk_1` FOREIGN KEY (`id_a`) REFERENCES `aluno` (`id_a`) ON DELETE CASCADE,
  CONSTRAINT `aluno_disciplina_ibfk_2` FOREIGN KEY (`id_d`) REFERENCES `disciplina` (`id_d`) ON DELETE CASCADE
